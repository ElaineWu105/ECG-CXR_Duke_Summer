...
OUT="$ROOT/7.19/label_multipositive_top10_learnable_n2"
[[ -f "$EXP/setup_env.sh" ]] && source "$EXP/setup_env.sh"

export MULTIPOS_NAME="single_n2_label_multipos_top10_learnable"
export TARGET_WINDOW="[t2-14h, t2-2h]"

PYTHONUNBUFFERED=1 python -u "$ROOT/7.19/train_label_multipositive_learnable.py" \
